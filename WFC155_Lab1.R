#### Welcome to your first lab for WFC 155! ####
...
# NOTE: Packages are tools that have pre-written bundled code to make our own data processing easier. 
# Our computers in SciLab 2020 already have all our necessary packages downloaded. Awesome!
# But, if you are working from home or are in a different computer lab, you'll need to download your
#   own packages. You can do so by using install.packages("") as shown below.
#install.packages("palmerpenguins")

# Once you have your package installed, you can load it into your workspace using library()
...
#** QUESTION 4: What kind of home range estimator is best for environments with hard boundaries, like
#   lakes or urban areas? Why?

#** QUESTION 5: If you wanted to understand why wombats are only located in Australia,
