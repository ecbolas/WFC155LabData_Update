#### Welcome to your second lab for WFC 155! ####
...
# Later, we'll also need this color package, so install it now if you are on a non-SciLab 2020 computer
...
#** QUESTION 3: Based on looking at the figure you made, on Dream Island, is there a 
...
#** QUESTION 6: Which two movement parameters do you need to sample from a track in order to 
#             perform a habitat selection analysis by fitting step-selection function? 
#             
#** QUESTION 7: How might the risk of predation affect an animal's use of space when foraging? 
#             (Hint: refer to the reading)
